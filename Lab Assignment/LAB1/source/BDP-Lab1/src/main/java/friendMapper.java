...
public class friendMapper extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text>{
    public void map(LongWritable key, Text value, OutputCollector<Text, Text> output, Reporter reporter)
        ...
        //iterate over each line (as tokens) from input, split user and friends list (at "-"), then split friends list
